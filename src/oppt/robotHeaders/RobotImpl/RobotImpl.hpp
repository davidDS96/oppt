...
protected:
    ...
    virtual void changeObstaclePoseCallback(const std::string& name, const VectorFloat& poseVec) override;
...
protected:
    ...
    virtual void registerOnPoseChangedCallback(std::function<void(const std::string&, const VectorFloat&)>& callback) override;
