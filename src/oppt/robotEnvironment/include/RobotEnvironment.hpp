...
private:
    ...
    bool changeObstaclePose(const std::string& name, const VectorFloat& poseVec, bool executeCallbacks = true);
...
private:
    ...
    void onObstaclePoseChanged(const std::string& str, const VectorFloat& pose);
    ...
    std::function<void(const std::string&, const VectorFloat&)> onObstaclePoseChangedFn_ = NULL;
