...
public:
     ...
     */
    void setUserData(const RobotStateUserDataSharedPtr& userData) {
        userData_ = userData;
    }
     ...
     */
    const RobotStateUserDataSharedPtr getUserData() const {
        return userData_;
    }
...
protected:
    ...
    RobotStateUserDataSharedPtr userData_ = nullptr;
