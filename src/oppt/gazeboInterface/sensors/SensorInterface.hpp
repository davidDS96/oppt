...
typedef std::map<std::string, VectorSensor> WorldSensorMap;
...
public:
    ...
    void getCombinedObservation(VectorFloat &observation, const std::string &worldName);
    
    ~SensorInterface() {}
    
private:
    WorldSensorMap worldSensorMap_;
