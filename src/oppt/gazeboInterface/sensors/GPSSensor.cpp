...
void GPSSensor::getObservationLimits(VectorFloat& lowerLimits, VectorFloat& upperLimits) const
{
    ...
    lowerLimits[0] = -gazebo::math::Angle::Pi.Radian();
    lowerLimits[1] = -gazebo::math::Angle::Pi.Radian();
    lowerLimits[2] = -100;    
    upperLimits[0] = gazebo::math::Angle::Pi.Radian();
    upperLimits[1] = gazebo::math::Angle::Pi.Radian();
    upperLimits[2] = 100;
}
