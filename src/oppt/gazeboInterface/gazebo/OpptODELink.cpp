...
void OpptODELink::OpptMoveCallback(dBodyID _id)
{
    ...
    gazebo::math::Vector3 cog = self->dirtyPose.rot.RotateVector(
...
gazebo::math::Vector3 OpptODELink::GetWorldForce() const
{
    return this->force;
}

gazebo::math::Vector3 OpptODELink::GetWorldTorque() const
{
    return this->torque;
}
