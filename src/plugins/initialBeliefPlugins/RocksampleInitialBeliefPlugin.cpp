...
public:
    ...
    virtual RobotStateSharedPtr sampleAnInitState() override {
        ...
        robotEnvironment_->getGazeboInterface()->makeInitialWorldState(options->initialStateVec);
        ...
        initState->setGazeboWorldState(robotEnvironment_->getGazeboInterface()->getInitialWorldState());	
        return initState;
    }
