#ifndef __FRAPU_ABT_SIMULATOR_HPP__
#define __FRAPU_ABT_SIMULATOR_HPP__
...
namespace abt
{
class FrapuABTSimulator: public Simulator
{
public:
    FrapuABTSimulator(std::unique_ptr<Model> model, Solver* solver, bool hasDynamicChanges);
