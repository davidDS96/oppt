...
After registering a planning environment for environment changes, whenever the execution environment changes, the same changes are automatically applied to the planning environment.
